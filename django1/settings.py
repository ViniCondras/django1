...
SECRET_KEY = 'django-insecure-k8c$*ta8gwv+$77a3gf95(-!=&hdu4-(+@v_uv#(-8f_8q23q3'

# SECURITY WARNING: don't run with debug turned on in production!
#DEBUG com valor True modo em Desenvolvimento (STATIC_URL)
#DEBUG com valor False modo em Produção (STATIC ROOT)

DEBUG = False

ALLOWED_HOSTS = ['*'] #www.estrangeiras.com
